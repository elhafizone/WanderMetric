      ...
      <Container width="narrow">
        <Stack gap="tight">
          ...
          <div className="prose-page flex flex-col gap-5">
            <p>
              WanderMetric earns commission when a reader books through some of the links
              on this site. This page explains exactly how that works.
            </p>
            ...
            <p>
              ...
              booking, the partner pays us a percentage of what they earn. The price you
              pay is identical either way — the commission comes out of the
              partner&rsquo;s margin, not out of your pocket.
            </p>
            <h2 className="mt-4 text-xl font-semibold tracking-tight">
            ...
            <p>
              ...
              , which is the attribute search engines expect on a paid link, and every
              page carrying them shows a disclosure next to the links themselves rather
            ...
            <ul className="text-ink-muted flex list-disc flex-col gap-2 pl-5">
              ...
              <li>
                What we say about them. A place we like gets a good write-up whether or
                not it pays.
              </li>
            ...
            <p>
              Disclosure is legally required — by the FTC in the United States, the CAP
              Code in the UK, and equivalent rules elsewhere. It is also simply the right
              way to run a site funded this way: you should know how the thing you are
              reading makes money.
            </p>
          </div>
        </Stack>
