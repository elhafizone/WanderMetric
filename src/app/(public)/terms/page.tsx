    ...
    <Container width="narrow">
      <Stack>
        ...
        <div className="prose-page flex max-w-[68ch] flex-col gap-5 text-[17px]/[1.7]">
          <h2 className="mt-4 text-xl font-semibold tracking-tight">Use of this site</h2>
          <p>
            WanderMetric is provided for personal, non-commercial use. You may link to any
            page here freely.
          </p>
          ...
          <p>
            ...
            find them, you should confirm anything time-sensitive with the operator before
            you travel. We do not warrant that every detail is current.
          </p>
          ...
          <p>
            Text and design on this site belong to WanderMetric unless credited otherwise.
            Short quotations with attribution and a link are welcome; wholesale
            reproduction is not.
          </p>
