    ...
    <Container width="narrow">
      <Stack>
        ...
        <div className="prose-page flex max-w-[68ch] flex-col gap-5 text-[17px]/[1.7]">
          ...
          <h2 className="mt-4 text-xl font-semibold tracking-tight">How we are funded</h2>
          <p>
            We earn commission when a reader books through a partner link on this site.
            That funding model only works if the recommendations are worth trusting, so it
            is separated from the editorial work: commission rates never influence what we
            cover, what we recommend, or what we say about it.
          </p>
          <p>
          ...
          <ul className="text-ink-muted flex list-disc flex-col gap-2 pl-5">
            <li>
              Publish invented prices, availability, ratings or reviews. If we do not hold
              the data, we do not show a number.
            </li>
            <li>
              Mass-generate thin pages to chase search traffic. A destination page cannot
              be published here until it carries real, original substance — that rule is
              enforced by the database, not by good intentions.
            </li>
