      ...
      <Container width="narrow">
        <Stack gap="tight">
          ...
          <div className="prose-page flex flex-col gap-5">
            <p>
              This policy describes what this site actually does. It is written against
              the implementation rather than copied from a template.
            </p>
            ...
            <ul className="text-ink-muted flex list-disc flex-col gap-2 pl-5">
              <li>
                Your IP address is never stored. It is used only to derive a country at
                the edge, and is then discarded.
              </li>
            ...
            <p>
              ...
              partner then applies its own privacy policy, which we do not control. We
              never pass your personal details to a partner, because we do not hold them.
            </p>
            ...
            <p>
              ...
              underlying rows are aged out. Aggregated statistics contain no identifiers
              of any kind.
            </p>
